...
,
  {
    ...
    emoji: '🏴',
    desc:  'Control del centro desde el flanco. Juego flexible e hipermoderno.',
    moves: ['c2c4','e7e5','b1c3','g8f6','g1f3','b8c6','g2g3','f8b4'],
    hints: [
      'c4 — control del centro desde el flanco sin avanzar peones centrales.',
      'El rival ocupa el centro con e5.',
      'Desarrolla el caballo hacia el centro.',
      'El rival desarrolla su caballo f6.',
      'Caballo f3 — desarrollo natural.',
      'El rival desarrolla su caballo c6.',
      'g3 — prepara el enroque y el alfil en la gran diagonal.',
      'El rival presiona con el alfil a b4.',
    ],
  },
  {
    id:    'nimzo-india',
    ...
    emoji: '🔱',
    desc:  'Respuesta sólida a d4. El alfil clava el caballo y frena el centro.',
    moves: ['d2d4','g8f6','c2c4','e7e6','b1c3','f8b4','d1c2'],
    hints: [
      'Blancas avanzan d4 controlando el centro.',
      'Negras responden con Cf6, desarrollo activo.',
      'Blancas juegan c4 — el sistema de la India.',
      'Negras preparan Ab4 con e6.',
      'Blancas desarrollan el caballo a c3.',
      'Negras juegan Ab4 — la Nimzo-India. Clava el caballo.',
      'Blancas juegan Dc2 protegiendo e4 y preparando el centro.',
    ],
  },
  {
    id:    'reti',
    name:  'Apertura Réti',
    emoji: '🌀',
    desc:  'Apertura hipermoderna. El caballo controla el centro desde lejos.',
    moves: ['g1f3','d7d5','c2c4','d5c4','e2e3','g8f6','f1c4','e7e6'],
    hints: [
      'Cf3 — apertura Réti. Desarrollo sin comprometer peones centrales.',
      'El rival ocupa el centro con d5.',
      'c4 — ataca el peón central del rival.',
      'El rival captura en c4.',
      'e3 — prepara recuperar el peón y abre la diagonal del alfil.',
      'El rival desarrolla el caballo f6.',
      'Alfil a c4 — recupera el peón con pieza activa.',
      'El rival consolida con e6.',
    ],
  },
  {
    id:    'holandesa',
    ...
    emoji: '🌷',
    desc:  'Respuesta agresiva a d4. Las negras buscan ataque en el flanco de rey.',
    moves: ['d2d4','f7f5','g2g3','g8f6','f1g2','e7e6','g1f3','f8e7','e1g1'],
    hints: [
      'Blancas avanzan d4.',
      'Negras juegan f5 — la Holandesa. Ataque en el flanco de rey.',
      'g3 — prepara el alfil en la gran diagonal.',
      'Negras desarrollan el caballo f6.',
      'Alfil a g2 — fianchetto, gran diagonal activa.',
      'Negras preparan el desarrollo con e6.',
      'Caballo f3 — desarrollo natural.',
      'Negras desarrollan el alfil a e7.',
      'Blancas enrocan corto — posición segura.',
    ],
  },
  {
    id:    'bird',
    name:  'Apertura Bird',
    emoji: '🦅',
    desc:  'f4 desde el inicio. Control del flanco de rey poco convencional.',
    moves: ['f2f4','d7d5','g1f3','g8f6','e2e3','e7e6','f1e2','f8e7','e1g1'],
    hints: [
      'f4 — la apertura Bird. Control del flanco de rey desde el inicio.',
      'El rival responde con d5 al centro.',
      'Cf3 — desarrollo natural.',
      'El rival desarrolla su caballo.',
      'e3 — refuerza el centro y abre la diagonal del alfil.',
      'El rival prepara el desarrollo con e6.',
      'Alfil a e2 — desarrollo sólido.',
      'El rival desarrolla su alfil.',
      'Blancas enrocan corto asegurando el rey.',
    ],
  },
];
